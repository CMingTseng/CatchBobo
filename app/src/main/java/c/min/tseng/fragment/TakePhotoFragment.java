...
public class TakePhotoFragment extends Fragment {
    ...
    //public class TakePhotoFragment extends Activity implements SurfaceHolder.Callback, LocationListener {
...
//    Guides mGuides;//畫線
//
//    private static final String LOGGER = TakePhotoFragment.class.getName();
//
//    // 引導其他class
//    Intent fragment_billing = new Intent();
//
//    //照片處理
//    Bitmap bmp, bmpt;
...
//        holder.addCallback(TakePhotoFragment.this);
...
//--------- SurfaceHolder設定---------------------------------------------------
//    final SurfaceView surfaceView = (SurfaceView) child.findViewById(R.id.surfaceview);
//    final ImageButton takephoto = (ImageButton) child.findViewById(R.id.cameraImgBtn01);
...
//            // TODO Auto-generated method stub
//
//            fragment_billing.setClass(TakePhotoFragment.this, BillingFragment.class);
...
//			/* SD卡不存在，顯示Toast資訊 */
//                Toast.makeText(TakePhotoFragment.this,
...
////	it.setClass(TakePhotoFragment.this,Tessmotor.class);
////	startActivity(it);
////	}
////
////
